...
from_dm_nerf_path = Path("/research/d1/gds/rszhu22/Contrastive-Lift/data/replica")
from_semantic_nerf_path = Path("/research/d1/gds/rszhu22/Contrastive-Lift/data/replica/raw/Replica_Dataset")
from_replica_github = Path("/research/d5/gds/rszhu22/RGB_Recon/vMAP/data/vmap")
# import shutil
...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_path', required=False, default='data/replica_customized/room_1', help='sens file path')
    ...
    scenes_list=[ "room_2", "office_0", "office_2", "office_3", "office_4"]
    base_dir = "data/replica_customized"
    for scene in scenes_list:
        args.root_path = f"{base_dir}/{scene}"
        ...
        ##
        panoptic_src_folder = f"/research/d1/gds/rszhu22/Contrastive-Lift/data/replica/{scene}/panoptic"
        print(panoptic_src_folder)
        # 目标文件夹路径
        panoptic_dst_folder = f"{args.root_path}/panoptic"
        print(panoptic_dst_folder)
        # 移动文件夹
        # exit()
        if not os.path.exists(panoptic_dst_folder):
            shutil.move(panoptic_src_folder, panoptic_dst_folder)
        # os.system("mv /research/d1/gds/rszhu22/Contrastive-Lift/data/replica")
