...
preview_path = Path("/research/d1/gds/rszhu22/ml-hypersim/contrib/99991/downloads/")
multiframe_path = Path("/research/d1/gds/rszhu22/ml-hypersim/contrib/99991/downloads/")
raw_path = Path("/research/d1/gds/rszhu22/ml-hypersim/contrib/99991/downloads/")
...
def load_camera_params(data_dir, seq_id):
    ...
    seq_data = None
    # print(path.join(data_dir,seq_id, "_detail", "metadata_cameras.csv"))
    with open(path.join(data_dir, CAMERA_PARAMS_FILE), newline="") as fid:
    # with open(path.join(data_dir,seq_id, "_detail", "metadata_cameras.csv"), newline="") as fid:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_path', required=False, default='data/hypersim/', help='sens file path')
    ...
    scenes_list = ["ai_001_010"]
    # scenes_list= ["ai_001_008", "ai_001_010","ai_008_004","ai_010_005","ai_035_001"]
    # scenes_list= ["ai_001_008","ai_008_004","ai_010_005","ai_035_001"]
    
    for scene_item in scenes_list:
        dest = Path(args.root_path)/scene_item
    ...
    # base_dir = "data/replica_customized"
        ...
        if True:
            ...
            print("RUN MASK2FORMER NOW BEFORE PROCEEDING TO NEXT STEP!")
        # exit()
        # breakpoint()
        # GT scannet labels
